      ...
      <div className='flex items-center justify-center min-h-screen bg-gray-100 pt-12'>
        <div className='w-full max-w-md p-8 m-4 bg-white rounded shadow-md'>
          ...
          <p className='text-center text-gray-700'>
            Trouble accessing your account? Provide your registered email, and
            we'll guide you through a quick and secure password reset.
          </p>
          ...
          <p className='mt-6 text-center text-sm text-gray-600'>
            ...
            <Link to={'/contact'}>
              <a
                href='#'
                className='text-indigo-700 hover:text-indigo-900 no-underline'
              >
                Contact Support
              </a>
            </Link>
